...
final class VarHandleMemoryAddressAsBytes {
    ...
    @ForceInline
    static byte get0(VarHandleMemoryAddressBase handle, Object obb, long base) {
    ...
    @ForceInline
    static void set0(VarHandleMemoryAddressBase handle, Object obb, long base, byte value) {
    ...
    @ForceInline
    static byte getVolatile0(VarHandleMemoryAddressBase handle, Object obb, long base) {
        MemoryAddressProxy bb = checkAddress(obb, base, handle.length, true);
    ...
    @ForceInline
    static void setVolatile0(VarHandleMemoryAddressBase handle, Object obb, long base, byte value) {
        MemoryAddressProxy bb = checkAddress(obb, base, handle.length, false);
    ...
    @ForceInline
    static byte getAcquire0(VarHandleMemoryAddressBase handle, Object obb, long base) {
        MemoryAddressProxy bb = checkAddress(obb, base, handle.length, true);
        return convEndian(handle.be,
    ...
    @ForceInline
    static void setRelease0(VarHandleMemoryAddressBase handle, Object obb, long base, byte value) {
        MemoryAddressProxy bb = checkAddress(obb, base, handle.length, false);
    ...
    @ForceInline
    static byte getOpaque0(VarHandleMemoryAddressBase handle, Object obb, long base) {
        MemoryAddressProxy bb = checkAddress(obb, base, handle.length, true);
        return convEndian(handle.be,
    ...
    @ForceInline
    static void setOpaque0(VarHandleMemoryAddressBase handle, Object obb, long base, byte value) {
        MemoryAddressProxy bb = checkAddress(obb, base, handle.length, false);
